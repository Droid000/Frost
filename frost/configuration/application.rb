...
module Frost
  ...
  module Utilities
    ...
    # @return [String] The stringified integer as an ordinal suffix.
  ...
  class Configuration
    ...
    # @!visibility private
    PATH = "#{File.expand_path('../..', __dir__)}/config.yml".freeze
    ...
    def initialize
      ...
      @database_uri = String(data["Postgres"]["URI"])
  ...
  class Tundra
    ...
    def stop = @discord.stop

    # @see Discordrb::Bot#guilds
    def guilds = @discord.guilds

    # @see Discordrb::Bot#guild
    def guild(...) = @discord.guild(...)

    # @see Discordrb::Bot#channel
    def channel(...) = @discord.channel(...)

    # @see Discordrb::Bot#include!
    def include!(...) = @discord.include!(...)
  end
end
